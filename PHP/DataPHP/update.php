...
$upd = "update stud set  age=?, dob=?, addr=?, mob=?, email=? where name=?";
$stmt=mysqli_prepare($con,$upd);
mysqli_stmt_bind_param($stmt,"ssssss",$age,$dob,$addr,$mob,$email,$name);

mysqli_stmt_execute($stmt);

echo "<br><p>After updation</p>";
$result = $con->query($sql);
echo "<br><table border=\"1\">";
echo "<tr><th>NAME</th><th>AGE</th><th>DATE</th><th>ADDRESS</th><th>PHONE</th><th>EMAIL</th></tr>";
if ($result->num_rows>0)
